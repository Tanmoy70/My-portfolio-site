      ...
      <div className="services_container container grid">
        <div className="services_content">
          ...
          <span className="services_button">
            ...
            {/*onClick={() => toggleTab(1)*/}
            <a
              href="https://learn.deeplearning.ai/accomplishments/04719f6e-b81b-48a9-a3eb-61ad8f2e9b62"
        ...
        <div className="services_content">
          ...
          <span className="services_button">
            ...
            {/*onClick={() => toggleTab(2)}*/}
            <a
              href="https://www.udemy.com/certificate/UC-9ea3529e-0f05-4e0c-94ad-e714dacfb9ed/"
              style={{ color: "inherit", textDecoration: "none" }}
            >
              View Now
            </a>
        ...
        <div className="services_content">
          ...
          <span className="services_button">
            ...
            {/*onClick={() => toggleTab(3)}*/}
            <a
              href="https://www.udemy.com/certificate/UC-d5113239-5102-472f-aab5-97671f743d1a/"
              style={{ color: "inherit", textDecoration: "none" }}
            >
              View Now
            </a>
        ...
        <div className="services_content">
          ...
          <span className="services_button">
            ...
            {/*onClick={() => toggleTab(3)}*/}
            <a
              href="https://www.linkedin.com/learning/certificates/ce6c531dd855219f0fd52e976dd5cac98d7326ef2d775570a47bd2415cd594d7"
              style={{ color: "inherit", textDecoration: "none" }}
            >
              View Now
            </a>
        ...
        <div className="services_content">
          <div>
            ...
            {/* <i className="uil uil-edit services_icon"></i> */}
            <h3 className="services_title">
              1 Day AI Tools Workshop <br />
              <span className="services_title-line">from be10X</span>
            </h3>
          </div>
          <span className="services_button">
            {" "}
        ...
        <div className="services_content">
          <div>
            ...
            {/* <i className="uil uil-edit services_icon"></i> */}
            <h3 className="services_title">
              ChatGPT & AI Hacks with MS Office<br />
              <span className="services_title-line">from Skill Nation</span>
            </h3>
          </div>
          <span className="services_button">
            {" "}
